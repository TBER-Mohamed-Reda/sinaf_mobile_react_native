...
const DocOverView = ({ demandeStateCounter }) => {
      ...
      <View style={styles.item}>
        <View style={{ flexDirection: "row", alignItems: "center" }}>
          <View
            style={[
              styles.number,
              { backgroundColor: hexToRgb(treatedColor, 0.2) },
            ]}
          >
            <Text style={[styles.numberText, { color: treatedColor }]}>
              {demandeStateCounter.treatedCount}
            </Text>
          </View>
          <Text style={[styles.title, { color: treatedColor }]}>
            {`${t("administrativeFiles.treatedPlural")}`}
          </Text>
        </View>
      </View>
      <View style={styles.item}>
        <View style={{ flexDirection: "row", alignItems: "center" }}>
          ...
          >
            <Text style={[styles.numberText, { color: pendingColor }]}>
              {demandeStateCounter.pendingCount}
            </Text>
          </View>
          <Text style={[styles.title, { color: pendingColor }]}>
            {`${t("administrativeFiles.inProgress")}`}
          </Text>
        </View>
      </View>
    </>
